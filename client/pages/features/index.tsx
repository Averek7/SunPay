...
export default function Page() {
  ...
  const additionalFeatures = [
    {
      ...
      desc: "Manage multiple companies or teams from one dashboard. Seamless switching between orgs.",
      icon: Database,
      delay: "0.1s",
    },
    {
      title: "Real-Time Analytics",
      desc: "Track payroll trends, expenses, and compliance with interactive charts and reports.",
      icon: TrendingUp,
      delay: "0.2s",
    },
    {
      title: "Compliance Tools",
      desc: "Built-in tax calculations and regulatory checks tailored for global teams.",
      icon: Shield,
      delay: "0.3s",
    },
    {
      title: "API Integrations",
      desc: "Connect with your existing HR, accounting, and crypto tools for a unified workflow.",
      icon: Globe,
      delay: "0.4s",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-black via-slate-900 to-black relative overflow-hidden">
      ...
      <div
        className="absolute bottom-40 left-10 w-96 h-96 bg-[#00FFA3]/20 rounded-full blur-[120px] animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-1/2 left-1/2 w-96 h-96 bg-[#03E1FF]/10 rounded-full blur-[120px] animate-pulse"
      ...
      <section className="relative z-10 pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p
            className="text-xl text-slate-400 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in"
            style={{ animationDelay: "0.2s" }}
          >
            Explore how DappPay combines AI intelligence, Solana speed, and
            unbreakable security to transform your payroll process.
          </p>
        </div>
      </section>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  <div
                    className={`w-16 h-16 bg-linear-to-br ${feature.color} rounded-xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 shadow-lg`}
                  >
                    <feature.icon className="w-8 h-8 text-black" />
                  </div>
                  <h3
                    className={`text-2xl font-bold text-white mb-4 group-hover:${feature.textColor} transition-colors duration-300`}
                  >
                    {feature.title}
                  </h3>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-linear-to-br from-slate-900/90 to-slate-800/90 rounded-2xl p-8 sm:p-12 border border-[#DC1FFF]/20 backdrop-blur-sm">
              ...
              <p className="text-slate-400 mb-8 text-lg">
                Join thousands of businesses already using DappPay
              </p>
              <button
                onClick={() => router.push("/dashboard")}
                className="group/btn relative px-8 py-4 bg-linear-to-r from-[#DC1FFF] to-[#00FFA3] rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 overflow-hidden cursor-pointer"
              >
