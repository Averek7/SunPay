  ...
  <div className="group p-6 bg-linear-to-br from-slate-900/50 to-slate-800/30 border border-[#DC1FFF]/20 rounded-2xl backdrop-blur-sm hover:border-[#DC1FFF]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#DC1FFF]/20 relative overflow-hidden">
    ...
    <div className="relative z-10">
      <div className="flex items-center gap-3 mb-3">
        ...
        <h3 className="text-lg font-bold text-white group-hover:text-[#DC1FFF] transition-colors">
          {title}
        </h3>
      </div>
    ...
    <div className="border-b border-slate-800/50">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-bold text-white group-hover:text-[#00FFA3] transition-colors">
            {title}
          </h2>
        </div>
        <ChevronDown
      ...
      <main className="max-w-7xl mx-auto pb-20 px-6 pt-32">
        ...
        <Section id="intro" title="Getting Started" icon={BookOpen}>
          <div className="space-y-4 text-slate-300">
            <p>
              <span className="text-[#DC1FFF] font-bold">DappPay</span> is an
              innovative decentralized application (DApp) designed for seamless
              payroll management using blockchain technology powered by
              Solana&apos;s Rust programming language.
            </p>
            <p>
              This DApp enables organizations to automate their entire pay
              process—from adding workers in real-time with accurate salary
              details directly linked through unique identifiers, to creating
              new organizational entities effortlessly while ensuring compliance
              and security.
            </p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-200 text-sm leading-relaxed">
                    ...
                    <strong>your own OpenAI API key</strong> — this keeps your
                    usage private, secure, and gives you full control over
                    costs.
                    <br />
                    <br />
                    <strong>How to get one (30 seconds):</strong>
                    <br />
                    1. Go to →{" "}
                    <a
                      ...
                      target="_blank"
                      rel="noopener"
                      className="text-[#00FFA3] underline hover:text-white"
                    >
                    ...
                    <br />
                    <br />
                    Your key is stored <strong>only in your browser</strong> •
                    Free tier gives thousands of commands
                  </p>
                </div>
              </div>
            </div>
                ...
                <table className="w-full text-sm text-left text-slate-300">
                  ...
                  <tbody className="divide-y divide-slate-700">
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">List all organizations</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Show my organizations
                      </td>
                      <td className="px-6 py-4">Shows treasury balances</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">View org details</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Show details for Tesla
                      </td>
                      <td className="px-6 py-4">
                        Workers, salaries, last paid
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Create organization</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Create organization Apple
                      </td>
                      <td className="px-6 py-4">Instantly created</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Add worker</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Add worker 7yQ... to Tesla salary 3.5 SOL
                      </td>
                      <td className="px-6 py-4">Worker added</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Fund treasury</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Fund Tesla with 20 SOL
                      </td>
                      <td className="px-6 py-4">SOL transferred</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Pay everyone</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Process payroll for Tesla
                      </td>
                      <td className="px-6 py-4">All workers paid</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Withdraw</td>
                      <td className="px-6 py-4 font-mono text-[#00FFA3]">
                        Withdraw 8 SOL from Tesla
                      </td>
                      <td className="px-6 py-4">Sent to your wallet</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <p className="text-sm text-slate-400 mt-4">
                Pro tip: The AI remembers your organization names — just use the
                name you gave it!
              </p>
            </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-300">
                    Start by connecting your Solana wallet to the dashboard.
                    This enables transactions and fund management.
                  </p>
                </div>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    desc: 'Ask the AI: "Create organization TechCorp"',
                  },
                  {
                    step: 2,
                    title: "Add Workers",
                    desc: "Add team members with their wallet addresses and salaries",
                  },
                  {
                    step: 3,
                    title: "Fund Treasury",
                    desc: "Transfer SOL to your organization&apos;s treasury wallet",
                  },
                  {
                    step: 4,
                    title: "Process Payroll",
                    desc: "Execute payments automatically or manually trigger cycles",
                  },
                  {
                    step: 5,
                    title: "Monitor & Withdraw",
                    desc: "Track transactions and manage treasury funds",
                  },
                ].map((item: StepItem) => (
                  <div
                    key={item.step}
                    className="flex gap-4 p-4 bg-slate-800/30 rounded-lg border border-slate-700/50 hover:border-[#DC1FFF]/30 transition-all"
                  >
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div
                    key={i}
                    className="p-4 bg-slate-800/50 rounded-lg border border-slate-700/50 hover:border-[#00FFA3]/30 transition-all"
                  >
                    <div className="flex items-start justify-between mb-2">
                      <h4 className="font-mono font-bold text-[#00FFA3]">
                        {fn.name}
                      </h4>
                      <span className="px-2 py-1 text-xs bg-[#DC1FFF]/20 text-[#DC1FFF] rounded">
                        Function
                      </span>
                    </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-300 mb-4">
                Navigate to the <span className="text-[#00FFA3]">/test</span>{" "}
                page to access a comprehensive test interface with all
        ...
        <Section
          id="mobile"
          title="Mobile & Tablet Experience"
          icon={Smartphone}
        >
          <div className="space-y-4 text-slate-300">
            ...
            <ul className="space-y-3 ml-4">
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-[#00FFA3] shrink-0 mt-0.5" />{" "}
                The organizations panel is hidden by default
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-[#00FFA3] shrink-0 mt-0.5" />{" "}
                Tap the <strong>glowing menu button</strong> (bottom-right or
                top-right) to open it
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle className="w-5 h-5 text-[#00FFA3] shrink-0 mt-0.5" />{" "}
            ...
            <div>
              ...
              <div className="overflow-x-auto rounded-lg border border-slate-700">
                <table className="w-full text-sm text-left text-slate-300">
                  ...
                  <tbody className="divide-y divide-slate-700">
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Nothing happens when I type</td>
                      <td className="px-6 py-4">
                        Did you set your OpenAI API key?
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">“Invalid orgPda” error</td>
                      <td className="px-6 py-4">
                        Use the exact org name from your list
                      </td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">Insufficient funds</td>
                      <td className="px-6 py-4">Fund the treasury first!</td>
                    </tr>
                    <tr className="hover:bg-slate-800/50">
                      <td className="px-6 py-4">
                        AI keeps asking for missing info
                      </td>
                      <td className="px-6 py-4">
                        Include org name + amount + wallet address
                      </td>
                    </tr>
                  </tbody>
                </table>
        ...
        <div className="mt-12 grid md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className="p-4 bg-slate-900/50 border border-slate-800 rounded-lg text-center hover:border-[#DC1FFF]/30 transition-all"
            >
